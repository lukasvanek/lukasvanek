      ...
      >
        ...
        <Fade>
          ...
          <p>
            ...
            restaurant. After uneasy decision of our founder, we moved to
            European market, focusing on cities with high tourism, namely
            Prague, Madrid and Barcelona.
            <br />
            We participated in gastroturism accelerator in San Sebastian.
            <br />
            In 2020 during the pandemic situation, our founder had to leave
            Spain and come to Korea, the country of his origin, therefore he had
            to cut the business development in Spain. In order to save the
            project we tried to adapt to different market once again, the
            restaurants of Seoul.
          </p>
        </Fade>
        <Fade>
        ...
        <Fade>
          ...
          <p>
            ...
            suboptimal, so I build my own microservice dedicated to the
            Waiteboard in Node.js using{' '}
            ...
            as ORM.
            <br />
            The second thing I developed was Dashboard for managers and owners
            of the restaurant, where they could manage their menu, translations
            of menu and other settings. The stack was very similar. Later we
            started using{' '}
            ...
            library.
            <br />
            The user app was initially separately written natively for Android
            and iOS. For both development and user experience reasons we decided
            to recreate the app as PWA using React and the same stack and
            Material UI.
            <br />
            ...
            into serious performance issues. So I initiated incremental
            migration to Node.js backend with{' '}
            <a href="https://nestjs.com/" target="_blank">
              Nest.js
            </a>
            . This made all requests faster by factor of ten.
            <br />
            Lastly during the trial of adaptation to Korean market I worked on
            new{' '}
            <a
